...
.DATA
  ...
  .CODE
    .STARTUP
        ...
        mov cx, 18     ; the length of te string
        mov dh, 13     ; the row number (10=> the 17th row) (0-24) (0=> the first row) (24=> the last row)
        mov dl, 33     ; the column number (20=> the 33rd column) (0-79) (0=> the first column) (79=> the last column)
        lea bp, t2     ; the address of the string
        int 10h        ; call the interruption 10h=> print a string in color
        ; ============ END PRINT A STRING IN COLOR ============
